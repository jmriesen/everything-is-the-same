...
The most valuable lesson I have learned from TDD is to focus on how you as the future end user want to consume the code before deciding how to implement it.
...
- Parasocial relationships: Being a fan of someone vs being a fan of someone's work.
